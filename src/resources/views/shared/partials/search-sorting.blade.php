<form action="{{ route('movies.index') }}" method="GET"
    class="flex gap-2">
    <select name="sortByYear" class="py-3 px-4 pe-9 block w-full bg-gray-100 border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none">
