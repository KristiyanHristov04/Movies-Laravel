<div id="message" class="hover:cursor-pointer flex items-start max-sm:flex-col bg-green-100 text-green-800 p-4 my-4 rounded-lg relative" role="alert">
    <div class="flex items-center max-sm:mb-2">
        ...
        <strong class="font-bold text-sm">Успешно!</strong>
    </div>
